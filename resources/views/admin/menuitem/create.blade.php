        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card card-primary">
                    ...
                    <form action="/admin/menuitem" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label for="link">Link Konten Menu</label>
                    ...
                    <div class="card-footer">
                        ...
                        <a href="/admin/menuitem/" class="btn btn-secondary">Kembali</a>
                    </div>
                    </form>
